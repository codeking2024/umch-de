                    ...
                    <div className="item">
                        <div className="work">
                            <div
                                ...
                                <div className={`text w-100  bg-dark opacity-75 text-white p-5 d-block z-0`}>
                                    <p className="text-center text-white">Paolina Mia, 3. Semester aus Paris,
                                        Frankreich</p>
                                    <h6 className="text-center fw-bold text-white">Ihr Erfahrungsbericht
                                        aus dem Lehrkrankenhaus
                                        in Moers</h6>
                                </div>
                            </div>
                        </div>
